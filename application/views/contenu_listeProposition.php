                    ...
                    <table class="table table-hover">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="<?php echo site_url('client/accepte/'.$proposition['id']); ?>"><label class="badge badge-warning">Accepter</label></a></td>
                          <td><a href="<?php echo site_url('client/refus/'.$proposition['id']); ?>"><label class="badge badge-danger">Refuser</label></a></td>
                        </tr>
                        <?php } ?>
